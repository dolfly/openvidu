...
resource "google_compute_firewall" "firewall" {
  ...
  allow {
    protocol = "tcp"
    ports    = ["22", "80", "443", "1935", "7881", "50000-60000"]
  }
  allow {
    protocol = "udp"
...
locals {
  ...
  ubuntu_image    = local.is_arm_instance ? "projects/ubuntu-os-cloud/global/images/family/ubuntu-2204-lts-arm64" : "projects/ubuntu-os-cloud/global/images/family/ubuntu-2204-lts"
...
wget https://github.com/mikefarah/yq/releases/download/$${YQ_VERSION}/yq_linux_${local.is_arm_instance ? "arm64" : "amd64"}.tar.gz -O - |\
tar xz && mv yq_linux_${local.is_arm_instance ? "arm64" : "amd64"} /usr/bin/yq
